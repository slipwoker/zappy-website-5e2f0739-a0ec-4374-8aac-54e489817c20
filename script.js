  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        valid = false;
        msg   = errorMessages[name] || errorMessages.default;
      } else if (value !== '') {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בית ציוני אמריקה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5e2f0739-a0ec-4374-8aac-54e489817c20',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5e2f0739-a0ec-4374-8aac-54e489817c20';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5e2f0739-a0ec-4374-8aac-54e489817c20';
